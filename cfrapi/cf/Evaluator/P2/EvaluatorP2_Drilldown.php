...
class EvaluatorP2_Drilldown implements EvaluatorP2Interface {
   ...
   *
   * @return \Donquixote\Cf\Evaluator\P2\EvaluatorP2_Drilldown
   */
  ...
  public function confGetValue($conf) {
    ...
    $subEvaluator = StaUtil::evaluatorP2($subSchema, $this->schemaToAnything);
  ...
  public function confGetPhp($conf) {
    ...
    elseif (NULL === $subEvaluator = StaUtil::evaluatorP2($subSchema, $this->schemaToAnything)) {

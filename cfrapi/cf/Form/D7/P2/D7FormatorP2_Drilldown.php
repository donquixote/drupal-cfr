 ...
 * @Cf
 */
class D7FormatorP2_Drilldown implements D7FormatorP2Interface, OptionableD7FormatorP2Interface {
  ...
  /**
   * @var (\Donquixote\Cf\Form\D7\P2\D7FormatorP2Interface|false)[]
   */
  private $formators = [];
   ...
   * @param string $id
   *
   * @return \Donquixote\Cf\Form\D7\P2\D7FormatorP2Interface|false
   */
  ...
  private function idBuildFormatorOrFalse($id) {
    ...
    if (FALSE === $formator = StaUtil::formatorP2(
      $schema,

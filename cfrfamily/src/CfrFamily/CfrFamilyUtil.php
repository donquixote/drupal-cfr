...
class CfrFamilyUtil {
   ...
   */
  public static function buildFamilyConfigurator(CfrLegendInterface $legend, IdConfToValueInterface $idConfToValue) {
   ...
   */
  public static function buildOptionalFamilyConfigurator(CfrLegendInterface $legend, IdConfToValueInterface $idConfToValue, $defaultValue = NULL) {
